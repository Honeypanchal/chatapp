              ...
              Container(
                ...
                child: Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * 0.062, vertical: height * 0.012),
                  child: Column(
                    ...
                    children: [
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text("Login/Register to Get started!",
                      ...
                      Padding(
                        ...
                        child: Text("Chat with people around you  easily.",
                            style: TextStyle(
                                fontFamily: 'Poppins',
                      ...
                      Padding(
                        padding:
                        EdgeInsets.symmetric(horizontal: width * 0.06),
                        child: Text("Sign in easily using Google/Facebook  ",
                            style: TextStyle(
                                fontFamily: 'Poppins',
                                fontSize: width * 0.029,
                                color: Colors.black)),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: Colors.white,
                              border: Border.all(
                                  color: Color(0xFFB485FA), width: 2),
                              borderRadius:
                              BorderRadius.circular(width * 0.05)),
                          child: Center(
                            child: Row(
